...
export default function OwnerProfile() {
  ...
  const COUNTRIES = [
    ...
    "Japan", "China", "Brazil", "Mexico", "Spain", "Italy", "Netherlands",
            ...
            <div className="card-body">
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div className="row g-3">
                  ...
                  <div className="col-md-12">
                    <label className="form-label">
                      <i className="bi bi-chat-left-text me-1"></i>About Me / Property Host Bio
                    </label>
                    <textarea
                      name="about"
                      value={form.about}
                      ...
                      className="form-control"
                      rows="4"
                      placeholder="Tell potential guests about yourself as a host, your hosting style, properties..."
                    />
                  </div>
                </div>
